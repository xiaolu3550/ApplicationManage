package com.benlian.commlib.log;
 ...
 * @Author: xiaol
 * @CreateDate: 2021/1/16 17:21
 * @UpdateUser: xiaol
 * @UpdateDate: 2021/1/16 17:21
 * @UpdateRemark: 更新说明
 * @Version: 1.0
 * ================================================
 */
public class LogUtil {
    ...
    private static final int JSON_D = 0x7;
    private static final int JSON_I = 0x9;
    ...
    public static void jsonD(String jsonFormat) {
        printLog(JSON_D, null, jsonFormat);
    }

    public static void jsonI(String jsonFormat) {
        printLog(JSON_I, null, jsonFormat);
    }

    public static void json(String tag, String jsonFormat) {
        printLog(JSON_D, tag, jsonFormat);
    }
    ...
    private static void printStackTrace() {
        ...
        for (String trace : traceString) {
            if (trace.contains("at com.xiaolu.mylibrary.log.LogUtil")) {
                continue;
            }
    ...
    private static void printLog(int type, String tagStr, Object... objects) {
        ...
        switch (type) {
            ...
            case A:
                ...
                break;
            case JSON_D:
                JsonLog.printJsonD(tag, msg, headString);
                break;
            case JSON_I:
                JsonLog.printJsonI(tag, msg, headString);
                break;
            case XML:
    ...
    private static String[] wrapperContent(int stackTraceIndex, String tagStr, Object... objects) {
        ...
        if (classNameInfo.length > 0) {
            className = classNameInfo[classNameInfo.length - 1] + "." + split[1];
        }
        ...
        if (objects.length == 0) {
            ...
            msg = (objects == null) ? NULL_TIPS : getObjectsString(objects);
        }
